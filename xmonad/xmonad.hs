...
myFont :: String
myFont = "xft:KKong3:size=19:antialias=true:hinting=true"
...
myTerminal :: String
myTerminal = "termite"   -- 默认t

myBrowser :: String
myBrowser = "firefox "   -- 默认浏览器 
